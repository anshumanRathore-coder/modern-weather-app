    ...
    <>
            ...
            <VStack color="#5e82f4" fontWeight="bold">
              ...
              <Box>
                <HStack>
                  ...
                  <Text fontSize="1.5em">
                    {element.tempmin}<sup>o</sup>C
                  </Text>
                </HStack>
              </Box>
              <Box>
                <Text fontSize="1.5em">{element.conditions}</Text>
              </Box>
            </VStack>
          </Box>
        </Box>
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent borderRadius="2em">
          <VStack>
          <ModalCloseButton />
          <ModalHeader width="80%" mt="25px"backgroundColor="#5e82f4" rounded="2em" color="white" fontWeight="bold" >
          <Center>
              <VStack mt="5px">
                <Text>{element.datetime}</Text>
                <Text>Wednesday</Text>
